...
import { LIVE_WEBSITE_AUDIT_AGENTS, LIVE_COMPETITOR_AUDIT_AGENTS, LIVE_LIGHTHOUSE_AGENTS, SINGLE_RUN_AGENTS } from "@/lib/agent-prompts";
  ...
  return (
    <main className="max-w-3xl mx-auto px-8 py-10">
      ...
      <AgentRunner
        ...
        competitorUrlField={LIVE_COMPETITOR_AUDIT_AGENTS.has(agentKey) || LIVE_LIGHTHOUSE_AGENTS.has(agentKey)}
        textInputField={getTextInputSpec(agentKey)}
        singleRun={SINGLE_RUN_AGENTS.has(agentKey)}
        runs={runs.map((r) => ({
          id: r.id,
